...
def create(game_parts, configs):
    ...
    fig.scatter(
        marker="circle_dot", x="xs", y="ys", source=fig_src, size=configs.score_dots.size,
        line_color=configs.score_dots.line_color,
        fill_color=configs.score_dots.fill_color, alpha=configs.score_dots.alpha
    )
    fig.scatter(
        marker="circle_dot", x="xs", y="chance_ys", source=fig_src, size=configs.chance_dots.size,
        line_color=configs.chance_dots.line_color,
        fill_color=configs.chance_dots.fill_color,
        alpha=configs.chance_dots.alpha
    )
    fig.scatter(
        marker="circle_dot", x="xs", y="ys", source=fig_src, size=configs.highlight_dots.size,
