...
class Configs:
    ...
    def __init__(
        ...
        keeper_head_line_width=2, keeper_head_size=3, keeper_body_x=50,
        ...
        striker_head_line_width=2, striker_head_size=3, striker_body_x=50,
        ...
        ball_fill_color="whitesmoke", ball_line_width=2, ball_size=2
    ):
...
def create(game_parts, configs):
    ...
    keeper_head = Circle(
        ...
        line_width=configs.keeper.head.line_width, radius=configs.keeper.head.size
    )
    keeper_body = Rect(
    ...
    ball = Circle(
        ...
        line_width=configs.ball.line_width, radius=configs.ball.size
    )
    ...
    striker_head=Circle(
        ...
        radius=configs.striker.head.size
    )
    striker_body = Rect(
